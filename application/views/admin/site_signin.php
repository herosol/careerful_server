        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <label for="account_heading" class="control-label">Left Heading<span class="symbol required">*</span></label>
                        <input type="text" name="account_heading" value="<?= $row['account_heading'] ?>" class="form-control" required>
                    </div>
                    <div class="col-md-4">
                        <label for="account_heading_heading" class="control-label">Link Text<span class="symbol required">*</span></label>
                        <input type="text" name="account_heading_heading" value="<?= $row['account_heading_heading'] ?>" class="form-control" required>
                    </div>
                    <div class="col-md-4">
                        <label for="account_heading_link" class="control-label">Link<span class="symbol required">*</span></label>
                        <select name="account_heading_link" id="account_heading_link" class="form-control" required>
                            <option value=''>-- Select --</option>
                            <?php $pages = get_pages();
                            foreach ($pages as $index => $page) { ?>
                                <option value="<?= $index ?>" <?= ($row['account_heading_link'] == $index) ? 'selected' : '' ?>> <?= $page ?></option>
                            <?php
                            }
                            ?>
                        </select>
