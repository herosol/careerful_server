            ...
            <div class="form-group">
                ...
                <?php for($i = 1; $i <= 4; $i++):?>
                    <div class="col-md-3">
                        <div class="form-group">
                            <div class="col-md-12">
                                <label for="muj_step<?=$i?>" class="control-label"> Step <span class="symbol required">*</span></label>
                                <input type="text" name="muj_step<?=$i?>" value="<?= $row['muj_step'.$i] ?>" class="form-control" required>
                            </div>
                            <br/>
                            <div class="col-md-12">
                                <div class="panel panel-primary" data-collapsed="0">
                    ...
                    <table class="table table-bordered newTable" id="newTable">
                        ...
                        <?php foreach ($sec7s as $sec7) { ?>
                            <tr>
                                ...
                                <td>
                                    <textarea name="sec7_detail[]" id="sec7_detail" class="form-control ckeditor" placeholder="Text" rows="3"><?= $sec7->detail; ?></textarea>
                                </td>
                                <td>
                                    <!-- Notes: Image dimention : 200px x 200px -->
                                    <div id="imgDiv">
                                        <input type="file" name="sec7_image[]" accept="image/*" id="newImgInput" style="display: none;" />
                                        <img src="<?php echo get_site_image_src('images', $sec7->image, 'thumb_'); ?>" style="width: 80%; cursor: pointer;" id="newImg"> 
                                        <input type="hidden" name="sec7_pics[]" value="<?= $sec7->image; ?>"> 
                                    </div>
                                </td>
                                <td>
                        ...
                        <?php }else{ ?>
                            <tr>
                                ...
                                <td>
                                    <textarea name="sec7_detail[]" id="sec7_detail" class="form-control ckeditor" placeholder="Text" rows="3"></textarea>
                                </td>
                                <td>
                                    <!-- Notes: Image dimention : 200px x 200px -->
                                    <div id="imgDiv">
                                        <input type="file" name="sec7_image[]" accept="image/*" id="newImgInput" style="display: none;" />
                                        <img src="<?php echo get_site_image_src('images', $sec7->image, 'thumb_'); ?>" style="width: 40%; cursor: pointer;" id="newImg">
                                    </div>
                                </td>
                                <td>
